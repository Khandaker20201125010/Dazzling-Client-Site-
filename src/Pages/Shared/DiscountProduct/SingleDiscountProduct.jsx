...
const SingleDiscountProduct = ({ product }) => {
  ...
  return (
    <div className="w-[18rem] flex flex-col h-full grow justify-between  m-auto rounded-2xl bg-gradient-to-br from-white via-blue-800    to-gray-900 shadow-2xl relative overflow-hidden transition-all duration-300 transform hover:scale-90 cursor-pointer p-4">
      {/* Ribbon */}
